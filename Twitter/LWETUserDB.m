...
{    
    ...
    NSString *modelPath = [[NSBundle mainBundle] 
						   pathForResource:@"LWETUserDB" ofType:@"mom"];
...
- (NSPersistentStoreCoordinator *)persistentStoreCoordinator 
{
														   ...
														   error:&error]) 
	{
        /*
		 ...
		 it may be useful during development. If it is not possible to recover from 
		 the error, display an alert panel that instructs the user to 
         ...
         * Performing automatic lightweight migration by passing the 
		 following dictionary as the options parameter: 
		 ...
		 consult "Core Data Model Versioning and Data Migration 
